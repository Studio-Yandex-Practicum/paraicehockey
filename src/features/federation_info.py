...
from src.core.constants import ABOUT_FED_TEXT, FED_VALUES_TEXT, FED_ACTIVITIES_TEXT


def about_federation_keyboard():
    keyboard = [[InlineKeyboardButton('Ценности Федерации', callback_data='fed_values')],
                [InlineKeyboardButton('Направления деятельности', callback_data='fed_activities')],
